                ...
                <DialogContent>
                    ...
                    <div className="max-h-[70vh] overflow-y-scroll flex flex-col gap-6">
                        ...
                        <div className="grid w-full max-w-sm items-center gap-1.5">
                            ...
                            <div className="text-sm text-muted-foreground">How many hives are there in this hive-drop?</div>
                        </div>
                        <Separator />
                        <h4>Hives graded: {hiveDropHiveGrades.length}</h4>
                        <div className="flex flex-col gap-8 border-1 border-border rounded-md p-5">
                            {hiveDropHiveGrades.map((value, index) => (
                                <div key={index} className="flex gap-6 items-center">
                                    <p className="text-nowrap min-w-[60px]">Hive {index + 1}</p>
                                    <Slider 
                                    defaultValue={[value]}
                                    max={24}
                                    step={1}
                                    ...
                                    />     
                                    <div className="text-nowrap text-lg font-bold text-brand-dark min-w-[60px] text-right">{value}</div>                           
                                </div>
                            ))}                          
