...
export default function MobileSheet({ props }: { props: MobileSheetProps }) {
  ...
  console.log("does mobile sheet mount?");
  return (
    <div
      className={clsx(
        "px-6 pt-6 pb-20 rounded-xl w-full transition-all duration-400 h-9/10 absolute z-10 bg-white",
        { "top-1/10": isOpen, "top-9/10": !isOpen }
      )}
    >
            ...
            <AccordionContent>
              <div className="flex flex-col gap-6">
                ...
                <div className="grid w-full max-w-sm items-center gap-1.5">
                  ...
                  <Input
                    type="text"
                    id="auxilary-field-id"
                    placeholder="Auxilary Field ID"
                  />
                </div>
                <div className="grid w-full max-w-sm items-center gap-1.5">
